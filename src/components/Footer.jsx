  ...
  return (
    ...
    <div className="absolute top-0 w-full bg-gray-800 text-gray-300 pb-3 pt-5 rounded-tl-[125px]">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-5 grid-cols-2 border-b-2 border-gray-600 py-8">
        ...
        <div className='ml-5 md:ml-0'>
          ...
          <ol className="links">
            ...
            <li className="py-1"><a href="#">Achievements</a></li>
            <li className="py-1"><a href="#">Students</a></li>
            <li className="py-1"><a href="/contactUs">Contact</a></li>
          </ol>
        </div>
      ...
      <div className="flex flex-col max-w-[1240px] px-2 py-4 m-auto justify-between sm:flex-row text-center text-gray-500 items-center">
        <p>2023 &copy;Sarthaki, All rights reserved.</p>
        <div className="flex justify-between sm:w-[300px] pt-4 text-2xl gap-2">
            ...
            <a className='zoom-in' href="#" target='_blank'><figure><FaGithub /></figure></a>
